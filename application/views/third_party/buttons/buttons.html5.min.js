...
if(f){c.buttons.info(c.i18n("buttons.copyTitle","Copiar al porta papeles"),c.i18n("buttons.copySuccess",{1:"Copiado un registro al portapapeles",_:"Copiados %d registros al porta papeles"},a.rows),2E3);return}}catch(h){}}f=i("<span>"+c.i18n("buttons.copyKeys","Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","Copy to clipboard"),f,0);b[0].focus();b[0].select();
